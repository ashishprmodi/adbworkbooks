...
val config = Config(Map(
  "url"            -> "mstranning.database.windows.net",
  "databaseName"   -> "casestudy",
...
//SQL Data Warehouse related settings
    ...
    val sqlDwURL = "jdbc:sqlserver://mstranning.database.windows.net:1433;database=mstranning;user=adminuser@mstranning;password=Passw0rd;encrypt=true;trustServerCertificate=false;hostNameInCertificate=*.database.windows.net;loginTimeout=30"
